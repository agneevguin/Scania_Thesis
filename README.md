...
/Scania/Opencv/samples/python$ python video_gabor_read.py
...
convert *.jpg -flop -set filename:new "%t_R" "%[filename:new].jpg"   # save the new image with _R
