...
pred_dir = '/home/scania/Scania/Agneev/Download_Models/Agneev_Model_9_9548_Preliminary-test_With-pretrain_Gabor_epoch_30.0/Segnet_Labels/';
im_true_all = [];
im_pred_all = [];
...
f_true = dir(strcat(true_dir,'*.bmp'));         % true_dir bmp for 6820 and 9548
...
[C_9_9548_Gabor] = confusionmat(RGB_true_Vector,RGB_pred_Vector, 'order', order_9);
